...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bluucoin-project/bluucoin>";
    const std::string URL_WEBSITE = "<https://bluucoin.org>";

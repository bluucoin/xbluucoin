...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bluucoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bluucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bluucoin transaction") + "\n" +
              "  bluucoin-tx [options] -create [commands]   " + _("Create hex-encoded bluucoin transaction") + "\n" +
              "\n";

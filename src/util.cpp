...
const char * const BITCOIN_CONF_FILENAME = "bluucoin.conf";
const char * const BITCOIN_PID_FILENAME = "bluucoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bluucoin";
#else
    // Unix
